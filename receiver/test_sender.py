...
HEADER = struct.Struct('<IHHIIQQB3s') # Q startSample + B flags + 3s reserved = 36 bytes
...
def main():
    ...
    for seq in range(n_packets):
        ...
        packet = HEADER.pack(SIGNATURE, VERSION, args.channels, args.rate, FRAMES_PER_PACKET, seq, seq*FRAMES_PER_PACKET, 0, b"\x00\x00\x00") 
